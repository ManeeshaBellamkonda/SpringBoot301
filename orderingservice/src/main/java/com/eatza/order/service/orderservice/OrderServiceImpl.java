...
import com.eatza.order.dto.Delivery;
...
public class OrderServiceImpl implements OrderService {
	...
	@Autowired
	KafkaTemplate<String, Delivery> kafkaTemplate;
	...
	public Order placeOrder(OrderRequestDto orderRequest) throws OrderException {
		...
		for (OrderedItemsDto itemDto : itemsDtoList) {
			...
			delivery.setRestaurantId(savedOrder.getRestaurantId());

			kafkaTemplate.send("kafka_delivery_json", delivery);
